import{a as O}from"./vendor-e5c2d73b.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}})();const g=O.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}}),oe=async e=>{var o,s;const t=await g.post("/subscription",{email:e});if((o=t.data)!=null&&o.error)throw new Error(((s=t.data)==null?void 0:s.error)||"Subscription failed");return t.data},ne=async(e="Muscles",t=1)=>{const s=window.innerWidth<768?9:12;try{const n=await g.get("/filters",{params:{filter:e,page:t,limit:s}});if(!n.data)throw new Error("No data received");return n.data}catch(n){throw console.error("Error fetching categories:",n),new Error("Failed to fetch categories. Please try again later.")}},H=async()=>{try{return(await g.get("/quote")).data}catch(e){console.error("Error fetching the quote:",e)}},se=async({bodypart:e="",muscles:t="",equipment:o="",keyword:s="",page:n=1,limit:a=10})=>{try{return(await g.get("/exercises",{params:{bodypart:e,muscles:t,equipment:o,keyword:s,page:n,limit:a}})).data}catch(r){console.error("Error fetching exercises:",r)}},x=async e=>{try{return(await g.get(`/exercises/${e}`)).data}catch(t){console.error("Error fetching exercise by id:",t)}},c={items:[],categories:{category:"",target:""},pagination:{page:1,limit:10,pagesCount:1},search:""};function ae({category:e,target:t}){c.categories={category:e,target:t}}function re(){return c.categories}function ie(e){c.items=e.map(({_id:t,...o})=>({id:t,...o}))}function ce(){return c.items}function B(e){return c.items.find(({id:t})=>e===t)}function le({page:e,limit:t,pagesCount:o}){c.pagination={page:parseInt(e),limit:parseInt(t),pagesCount:parseInt(o)}}function S(){return c.pagination}function R(e){c.pagination.page=e}const u={ADDED:"added",REMOVED:"removed"};function b(){const e=localStorage.getItem("favorites");return e?JSON.parse(e):[]}function N({page:e}){const o=b(),s=o.length,n=Math.ceil(s/10);e<1&&(e=1),e>n&&(e=n);const a=(e-1)*10,r=Math.min(a+10,s),i=o.slice(a,r);return c.pagination={page:e,limit:10,pagesCount:n},i}function q(e){const t=b(),o=t.find(({id:s})=>s===e);return{result:o?u.ADDED:u.REMOVED,item:o,list:t}}function D(e){const{item:t,list:o}=q(e);return t?(_({list:o,id:e}),u.REMOVED):(V({list:o,id:e}),u.ADDED)}function V({list:e,id:t}){const o=B(t),s=[...e,o];localStorage.setItem("favorites",JSON.stringify(s))}function _({list:e,id:t}){const o=e.filter(({id:s})=>t!==s);o.length?localStorage.setItem("favorites",JSON.stringify(o)):localStorage.removeItem("favorites")}function de(e){c.search=e}function ue(){return c.search}function j({onChange:e,id:t}){const o=document.querySelector(`#pagination-${t}`),s=S();if(!J({container:o,paginationData:s}))return;document.querySelector('[data-element="pages-list"]').addEventListener("click",r=>{if(r.target.tagName==="BUTTON"){const i=Number(r.target.dataset.page),l=document.querySelector(".pagination-page.active"),d=document.querySelector(".page-btn.active");l.classList.remove("active"),d.classList.remove("active"),r.target.parentElement.classList.add("active"),r.target.classList.add("active"),e({page:i})}})}function J({container:e,paginationData:{pagesCount:t,page:o}}){if(t===1)return M({container:e}),!1;const s=Array.from({length:t}).reduce((n,a,r)=>{const i=r+1,l=i===o?"active":"";return n+=`<li class="pagination-page ${l}">
  ...
  <div class="favorites filtered-categories-content-top"> 
  ...
  </div>`,t.querySelector(".remove-button").addEventListener("click",s=>{const n=s.currentTarget.dataset.id,a={page:1};D(n),m({page:1}),T(a)}),t}y()==="favorites"&&document.addEventListener("DOMContentLoaded",()=>{m({page:1,isInit:!0}),j({id:"favorites",onChange:({page:e})=>{m({page:e})}})});const P=document.querySelector(".modal-container");document.addEventListener("DOMContentLoaded",function(){document.body.addEventListener("click",e=>{const t=e.target.closest(".start-button");if(t){const o=t.attributes["data-id"].value;z(o)}})});async function z(e){const{_id:t,...o}=await x(e);P.innerHTML=ee({id:e,...o});const s=document.querySelector(".modal-backdrop"),n=document.querySelector(".modal-close"),a=document.querySelector(".modal-favorite"),r=C({modal:s,modalCloseButton:n}),{result:i}=q(e);w({result:i,modalFavorite:a}),n.addEventListener("click",r),a.addEventListener("click",()=>{const l=D(e);if(w({result:l,modalFavorite:a}),y()==="favorites"){const d={page:1};m(d),T(d),r()}}),s.classList.add("is-open"),n.style.display="block",document.addEventListener("keydown",$({closeFn:r})),s.addEventListener("click",I({modal:s,closeFn:r}))}const Y={[u.ADDED]:X,[u.REMOVED]:Z};function w({result:e,modalFavorite:t}){const o=Y[e];o({modalFavorite:t})}function X({modalFavorite:e}){e.innerHTML=`<span>Remove from favorites</span>
    <svg class="remove-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="fill: currentColor;fill: currentColor;">
      <use href="./img/sprite.svg#icon-trash"></use>
                ...
                </svg>`}function $({closeFn:e}){return function(t){t.key==="Escape"&&e()}}function I({modal:e,closeFn:t}){return function(o){o.target===e&&t()}}function C({modal:e,modalCloseButton:t}){return function(){e.classList.remove("is-open"),t.style.display="none",document.removeEventListener("keydown",$),e.removeEventListener("click",I),t.removeEventListener("click",C),P.innerHTML=""}}function ee({id:e,gifUrl:t,name:o,rating:s,target:n,bodyPart:a,equipment:r,popularity:i,burnedCalories:l,time:d,description:A}){const F=s-parseInt(s)>.5?Math.round(s):Math.floor(s);return`<div class="modal-backdrop">
      <div class="modal">
    ...
    </div>`}export{ve as a,de as b,le as c,M as d,se as e,ne as f,ie as g,ge as h,j as i,ce as j,ae as k,ue as l,re as m,oe as s};
//# sourceMappingURL=modal-4d70ab2e.js.map
