...
background-size: cover;
    ...
    <svg class="remove-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="fill: currentColor;fill: currentColor;">
      <use href="./img/sprite.svg#icon-trash"></use>
                ...
                </svg>`}function R({closeFn:e}){return function(t){t.key==="Escape"&&e()}}function O({modal:e,closeFn:t}){return function(a){a.target===e&&t()}}function ue({modal:e,modalCloseButton:t}){return function(){e.classList.remove("is-open"),t.style.display="none",document.removeEventListener("keydown",R),e.removeEventListener("click",O),A.innerHTML=""}}function ge({id:e,gifUrl:t,name:a,rating:s,target:r,bodyPart:o,equipment:c,popularity:i,burnedCalories:d,time:y,description:N}){const _=s-parseInt(s)>.5?Math.round(s):Math.floor(s);return`<div class="modal-backdrop">
      <div class="modal">
        ...
        <div class="modal-inner">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-rating" id="rating" data-rate="${_}">
                <span>${s}</span>
                <div class="stars">
