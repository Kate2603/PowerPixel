import{s as P,h as T,a as $,b as B,f as I,c as C,d as F,i as g,e as H,g as A,j as D,k as j,l as z,m as G}from"./assets/modal-20896862.js";import{T as q,g as O}from"./assets/vendor-e5c2d73b.js";const R=()=>{document.getElementById("subscription-form").addEventListener("submit",async s=>{var a,r,l;s.preventDefault();const i=s.target.elements.email,t=i.value;try{const c=await P(t);if(c){const d=((a=c.data)==null?void 0:a.message)||c.message||"Subscription successful!";q({text:d,duration:3e3,style:{background:"#4CAF50"},close:!0}).showToast(),i.value=""}}catch(c){const d=((l=(r=c.response)==null?void 0:r.data)==null?void 0:l.message)||c.message||"An error occurred. Please try again later.";q({text:d,duration:3e3,style:{background:"#FF5F6D"},close:!0}).showToast()}})},u=document.querySelector(".js-search-form");u.addEventListener("submit",function(e){e.preventDefault();const s=e.target.firstElementChild.value;B(s),s?T():$(),L({page:1,isSearch:!0})});function b(){u.classList.contains("hidden-search")||u.classList.add("hidden-search")}function U(){u.classList.contains("hidden-search")&&u.classList.remove("hidden-search")}const V=document.querySelector('button[data-name="Muscles"]'),W=document.querySelector('button[data-name="Body parts"]'),_=document.querySelector('button[data-name="Equipment"]'),y=document.querySelector(".exercises-categories-list"),h=document.querySelector('[data-name="Muscles-item"]'),x=document.querySelector('[data-name="Body-parts-item"]'),S=document.querySelector('[data-name="Equipment-item"]'),p=document.querySelector(".current-category");let E;V.addEventListener("click",async()=>{h.classList.add("active"),S.classList.remove("active"),x.classList.remove("active"),f.classList.remove("hidden"),v.classList.add("hidden"),b(),p.innerHTML="",o({category:"Muscles",onMount:()=>{g({id:"exercises",onChange:({page:e})=>{o({category:"Muscles",page:e})}})}})});W.addEventListener("click",async()=>{h.classList.remove("active"),S.classList.remove("active"),x.classList.add("active"),f.classList.remove("hidden"),v.classList.add("hidden"),p.innerHTML="",b(),await o({category:"Body parts",onMount:()=>{g({id:"exercises",onChange:({page:e})=>{o({category:"Body parts",page:e})}})}})});_.addEventListener("click",async()=>{h.classList.remove("active"),S.classList.add("active"),x.classList.remove("active"),f.classList.remove("hidden"),v.classList.add("hidden"),p.innerHTML="",b(),o({category:"Equipment",onMount:()=>{g({id:"exercises",onChange:({page:e})=>{o({category:"Equipment",page:e})}})}})});async function o({category:e,onMount:s,page:i=1}){try{document.querySelector(".loader").classList.toggle("is-active",!0);const{results:t,page:a,perPage:r,totalPages:l}=await I(e,i);E=t,C({page:a,limit:r,pagesCount:l}),y.innerHTML="",y.insertAdjacentHTML("beforeend",K(E)),s&&s()}catch(t){console.log("Error fetching categories:",t)}finally{document.querySelector(".loader").classList.toggle("is-active",!1)}}async function J(){h.classList.add("active"),o({category:"Muscles",onMount:()=>{g({id:"exercises",onChange:({page:e})=>{o({category:"Muscles",page:e})}})}})}function K(e){return e.map(s=>{const{filter:i,name:t,imgURL:a}=s;return` <li class="exercises-categories-item" data-body-part='${t}' data-category-filter='${i}'>
...
background-size: cover;
	background-position: center;'
              ...
              </li>`).join("");document.addEventListener("DOMContentLoaded",()=>{R(),J()});new O({elements_selector:".lazy"});
